    ...
    <div v-if="infoData">
      <div class="topWrapper">
        <div class="shadeBox">
          ...
          <div class="lineWrapper"><span class="line"></span><span class="space"></span> <span class="line"></span>
          </div>
        ...
        <div class="cardBox">
          <div class="cardContent">
            ...
            <div class="card">
              <div class="leftCard">
                <div class="shadeBox">
                  <p class="cashNum" v-if="infoData.register_capital&&infoData.register_capital.length">
              ...
              <div class="rightCard">
                ...
                <p><a class="info-url" target="_blank" :href="infoData.url"><span class="infoTitle" :title="infoData.url">公司网址:</span><span
      ...
      <div class="companyDesc">
        <div class="leftDesc">公司简介
        </div>
        <div class="rightDesc" v-if="infoData.records&&infoData.records.length">
          <p class="title">已合作项目<span class="textBg"></span></p>
          <ul>
            <li v-for="item in infoData.records" :key="item.id" :title="item.content">{{item.content}}</li>
          </ul>
        </div>
      </div>
